...
async def run_client_review_post_submission_pipeline(client_review_id: str, is_retry: bool = False) -> None:
    ...
    try:
        ...
        #
        # predict_authenticity is no longer among them: it ranked templated reviews
        # as more genuine than real ones on this domain. See blend_authenticity.
        ...
        # Component 5, the one non-model check: does the review name anything from
        # this project? Same rule and same vocabulary as the freelancer side.
