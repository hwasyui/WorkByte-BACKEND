...
async def get_job_role_skill(job_role_skill_id: str, current_user: UserInDB = Depends(get_current_user)):
    ...
    try:
        ...
        logger("JOB_ROLE_SKILL", f"HTTP {e.status_code}: {e.detail}", "GET /job-role-skills/{job_role_skill_id}", "WARNING")
...
async def create_job_role_skill(job_role_skill: JobRoleSkillCreate, current_user: UserInDB = Depends(get_current_user)):
    ...
    try:
        ...
        mark_job_dirty_by_role(str(job_role_skill.job_role_id))
        ...
        logger("JOB_ROLE_SKILL", f"HTTP {e.status_code}: {e.detail}", "POST /job-role-skills", "WARNING")
        return ResponseSchema.error(e.detail, e.status_code)
    except Exception as e:
...
async def update_job_role_skill(job_role_skill_id: str, job_role_skill_update: JobRoleSkillUpdate, current_user: UserInDB = Depends(get_current_user)):
    ...
    try:
        ...
        mark_job_dirty_by_role(str(existing_job_role_skill["job_role_id"]))
        ...
        logger("JOB_ROLE_SKILL", f"HTTP {e.status_code}: {e.detail}", "PUT /job-role-skills/{job_role_skill_id}", "WARNING")
        return ResponseSchema.error(e.detail, e.status_code)
    except Exception as e:
...
async def delete_job_role_skill(job_role_skill_id: str, current_user: UserInDB = Depends(get_current_user)):
    ...
    try:
        ...
        jrid = str(existing_job_role_skill["job_role_id"])
        JobRoleSkillFunctions.delete_job_role_skill(job_role_skill_id)
        mark_job_dirty_by_role(jrid)
        ...
        logger("JOB_ROLE_SKILL", f"HTTP {e.status_code}: {e.detail}", "DELETE /job-role-skills/{job_role_skill_id}", "WARNING")
        return ResponseSchema.error(e.detail, e.status_code)
    except Exception as e:
